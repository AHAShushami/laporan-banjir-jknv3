 ...
 */
import { getSession, showToast, formatDateTime, formatNumber, calcChange, toCSV, downloadFile, getToday } from '../utils.js?v=23';
import { FORM_ORDER, FORM_CONFIGS, FORM_CATEGORIES } from '../config/forms.js?v=23';
import { DISTRICTS } from '../config/districts.js?v=23';
import { store } from '../store.js?v=23';
import { router } from '../router.js?v=23';
import { renderHeader, initHeader } from '../components/header.js?v=23';
import { renderSidebar, initSidebar } from '../components/sidebar.js?v=23';
import { SETTINGS } from '../config/settings.js?v=23';
...
export async function renderDashboardView() {
    ...
    for (const d of DISTRICTS) {
        ...
        const activePPSList = allPPS.filter(pps => {
            const openDateStr = pps.dateOpened ? pps.dateOpened.split('T')[0] : '';
            const closeDateStr = pps.dateClosed ? pps.dateClosed.split('T')[0] : '';
